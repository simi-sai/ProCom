...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{../images/floating_point/bits_transmitidos.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{../images/floating_point/impulso.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{../images/floating_point/frecuencia.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{../images/floating_point/salida_filtro.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../images/floating_point/diagrama_ojo.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{../images/floating_point/constelacion.png}
...
offset 3 se obtuvo un BER de $\approx$28.0 para el canal I y 14.87\% para el
canal Q, indicando que una selección incorrecta del offset de muestreo puede
introducir errores en la decodificación de los bits.

\begin{figure}[H]
    \centering
    \begin{lstlisting}[frame=single, basicstyle=\scriptsize\ttfamily]
    Bit Error Rate (BER) Results: (offset = 3)
    BER Canal I: 14.87 % (Errores: 76/511)
    BER Canal Q: 27.98 % (Errores: 143/511)
\end{lstlisting}
